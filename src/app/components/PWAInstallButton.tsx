  ...
  if (isInstalled) {
    ...
    return (
      <button
        ...
        className={`${baseClasses} px-6 py-3 rounded-lg font-bold transition-all duration-200 shadow-lg hover:shadow-xl transform hover:translate-y-[-4px] flex items-center space-x-2 ${className}`}
      >
